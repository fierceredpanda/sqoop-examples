CREATE SCHEMA IF NOT EXISTS simple_import;

CREATE TABLE IF NOT EXISTS simple_import.customer (
...
INSERT INTO simple_import.customer (first_name, last_name, street_address_1, street_address_2, city, state, zip)
VALUES
