CREATE SCHEMA IF NOT EXISTS delimiter;

CREATE TABLE IF NOT EXISTS delimiter.movie_reviews (
...
INSERT INTO delimiter.movie_reviews (name, rotten_tomatoes, create_date, modify_date) VALUES
