...
apt-get -q -y --force-yes install oracle-java8-installer oracle-java8-set-default cloudera-manager-server-db cloudera-manager-server cloudera-manager-daemons
...
echo oracle-java8-installer shared/accepted-oracle-license-v1-1 select true | sudo /usr/bin/debconf-set-selections
apt-get -q -y --force-yes install oracle-java8-installer oracle-java8-set-default
SCRIPT
